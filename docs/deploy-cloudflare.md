...
No hay base de datos. Los solvers desplegados (LP, transporte, asignación, redes/transbordo, colas, PERT/CPM + aceleración, EOQ) corren en TypeScript dentro del Worker. En el home aparecen los workbenches con `migrated: true`: LP, transporte, asignación, redes, PERT/CPM y EOQ. El resto del catálogo no se lista como activo.
